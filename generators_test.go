...
func ExampleIndexWordsFromStream() {
	found, err := IndexWordsFromStream(strings.NewReader(Address))
	if err != nil {
		panic(err)
	}
...
func ExampleIndexWordsFromStream_WithSpaces() {
	found, err := IndexWordsFromStream(strings.NewReader(AddressWithSpaces))
	if err != nil {
		panic(err)
	}
	for _, word := range found {
...
func ExampleIndexWordsFromStream_NoEndingLetter() {
	found, err := IndexWordsFromStream(strings.NewReader(NoEndingLetter))
	if err != nil {
		panic(err)
	}
	for _, word := range found {
